  ...
  <div class="app-container u-center">
    <el-form :model="dialogForm">
      ...
      <el-form-item label="工号" label-width="120px">
        <el-input v-model="dialogForm.workId" disabled style="width: 300px" autocomplete="off" />
      </el-form-item>
...
<script>
import { getManagerInfo, updateManagerInfo } from '@/api/userCenter'
...
export default {
  ...
  methods: {
    async submit() {
      ...
      const res = await updateManagerInfo(this.dialogForm)
      this.$message.success(res.message)
    },
    async userInfo() {
      const res = await getManagerInfo(this.id)
